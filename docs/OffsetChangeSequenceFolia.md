Offset Change Sequence: Folia
=============================
This document describes the sequence of events that occur on a Folia server when a player joins the server,
...
future versions of Folia. Remember that within a column, the ordering is generally deterministic, but the ordering
...
In 1.21.9, PlayerSpawnLocationEvent was deprecated and AsyncPlayerSpawnLocationEvent was introduced. The async event is
